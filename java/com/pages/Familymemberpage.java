...
public class Familymemberpage {
		...
		private By JOIN_YOUR_FAMILY_BTN = By.xpath("//a[@routerlink='/questionnaires']");
...
//		    	wait.waitForElementToBeClickable(YOPMAIL_REFRESH_BTN).click();
		 ...
		 //  driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(3));
		   WebElement joinyourfamily = wait.waitForVisibilityOfElement(JOIN_YOUR_FAMILY_BTN);
		   joinyourfamily.click();
