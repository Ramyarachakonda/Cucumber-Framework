...
public class Disasterplanningpage {
	...
	WebDriverWait wait;
	   ...
	   private By Disasterplanning=By.xpath("//a[contains(text(),'Disaster Planning')]");
	    ...
	    public void Emergencyprepback() throws InterruptedException {
	    	Thread.sleep(2000);
	    ...
	    public void Disasterplanning() throws InterruptedException {
	    	Thread.sleep(2000);
	    	WebElement disasterplanning=wait.until(ExpectedConditions.elementToBeClickable(Disasterplanning));
	    	disasterplanning.click();
