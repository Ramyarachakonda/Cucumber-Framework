...
public class IDspage {
	...
	private By IDsnewfolder = By.xpath("//p[@class='mb-0 file_length' and text()='\"+invitePersonName+\"']");
	...
	public void IDsnewfolder() throws InterruptedException {
		Thread.sleep(5000);
   ...
   WebElement send1= waitUtil.waitForElementToBeClickable(save);
